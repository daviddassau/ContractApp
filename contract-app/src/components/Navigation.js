            ...
            <div className="row">
                ...
                <div className="sidebar-sticky">
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="http://getbootstrap.com/docs/4.1/examples/dashboard/#">
                    ...
                    <a className="d-flex align-items-center text-muted" href="http://getbootstrap.com/docs/4.1/examples/dashboard/#">
